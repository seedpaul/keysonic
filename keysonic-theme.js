...
const THEMES = [
  {
    ...
    values: {
      ...
      "--key-saturation": 55,
      "--key-lightness": 88,
      "--key-border-saturation": 55,
      "--key-border-lightness": 72,
      "--key-active-saturation": 78,
      "--key-active-lightness": 48,
      "--accent": "#f97316",
  ...
  },
  {
    ...
    values: {
      ...
      "--key-saturation": 64,
      "--key-lightness": 82,
      "--key-border-saturation": 60,
      "--key-border-lightness": 62,
      "--key-active-saturation": 90,
      "--key-active-lightness": 46,
      "--accent": "#38bdf8",
  ...
  },
  {
    ...
    values: {
      ...
      "--key-lightness": 84,
      "--key-border-saturation": 55,
      "--key-border-lightness": 60,
      "--key-active-saturation": 88,
      "--key-active-lightness": 50,
      "--accent": "#f0abfc",
